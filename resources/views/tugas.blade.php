                ...
                <div class="p-6 flex flex-col md:flex-row items-center gap-8">
                    <section id="about-us" class="flex flex-col md:flex-row w-full">
                        <div class="md:w-1/2 flex justify-center mb-6 md:mb-0">
                            <img src="{{ asset('images/pp.png') }}" alt="About Us"
                        ...
                        <div class="md:w-1/2 text-gray-800">
                            ...
                            <p class="text-lg mb-4"><strong>Nama:</strong> Aulia</p>
                            <p class="text-lg mb-4"><strong>NIM:</strong> F1E122132</p>
                            <p class="text-lg mb-4"><strong>Mata Pelajaran :</strong> MPSI</p>
                            <p class="text-lg mb-4"><strong>UAS:</strong> {{ config('app.name') }}</p>
                        </div>
                    </section>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="p-6 flex flex-col md:flex-row items-center gap-8">
                    <section id="about-us" class="flex flex-col md:flex-row w-full">
                        ...
                        <div class="md:w-1/2 text-gray-800">
                            <h2 class="text-3xl font-bold mb-6">Tentang Sipadu</h2>
